...
const OrderHistory = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-4 md:mb-8 text-gray-800">Order History</h1>
              ...
              {filteredOrders.length === 0 ? (
                ...
                filteredOrders.map((order) => (
                  <motion.div
                    ...
                    whileHover="hover"
                    exit="exit"
                    className={`bg-white rounded-lg shadow-sm p-4 md:p-6 mb-3 hover:shadow-md transition-shadow cursor-pointer ${
        ...
        <div className="md:col-span-2">
          {selectedOrder ? (
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="bg-white rounded-lg shadow-lg p-4 md:p-6 space-y-4 md:space-y-6"
            >
